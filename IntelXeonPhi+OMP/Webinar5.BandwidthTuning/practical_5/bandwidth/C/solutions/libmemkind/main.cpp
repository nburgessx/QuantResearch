...
void add (mcdramvec::vector<real_t>& out,const mcdramvec::vector<real_t>& in1,const mcdramvec::vector<real_t>& in2);
void fill(mcdramvec::vector<real_t>& out,      mcdramvec::vector<real_t>& in1,      mcdramvec::vector<real_t>& in2);


int main(int argc,char** argv){
  int64_t n=500000000;
  mcdramvec::vector<real_t> z(n),x(n),y(n);
  fill(z,x,y);
